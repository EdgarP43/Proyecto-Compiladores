...
x El proyecto lo único que lo hacer perder su robustez total, es una separación demasiado específica en los tokens de los doubles cuando su terminación es incompleta con [eE][+-] y en la pantalla del Form, no limpia el archivo anterior, lo que causa una salida con todos los archivos subidos en la ejecución de lo contrario realiza todo bien tanto sus columnas de los tokens, número de línea, direccionamiento de cada token igual que las salidas en archivos y su entradas.
